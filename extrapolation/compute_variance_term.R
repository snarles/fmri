...
vfunc <- function(k, K, d, rcoeffs = FALSE) {
  ...
  sum(coeffs^2)/sqrt(2 * k)
}

## plot of v-functions

plot(2*(2:15), sapply(2:15, vfunc, K = 40, d = 1), 
     xlab = expression(k[max]), ylab = "v", ylim = c(0, 15),
...
legend(20, 12, legend = c("d = 1", "d = 2", "d = 3"), 
       col = c("black", "green", "red"),
       lwd = 2, pch = "o")

plot(2*(10:40), sapply(10:40, vfunc, K = 100, d = 2), 
     xlab = expression(k[max]), ylab = "v", ylim = c(0, 12),
     main = "K = 100, d = 2 to 5", type = "l", lwd = 2)
lines(2*(10:40), sapply(10:40, vfunc, K = 100, d = 3), col = "green", lwd = 2)
lines(2*(10:40), sapply(10:40, vfunc, K = 100, d = 4), col = "red", lwd = 2)
lines(2*(10:40), sapply(10:40, vfunc, K = 100, d = 5), col = "blue", lwd = 2)
legend(60, 8, legend = c("d = 2", "d = 3", "d = 4", "d = 5"), 
