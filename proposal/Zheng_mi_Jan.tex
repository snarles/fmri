...
\end{itemize}
\noindent\emph{Simulation Results}
\end{frame}
...
variable is smaller than the minimum of $K$ other $N(0, 1)$ variables
(all independent.)

Hence $\pi_K(0) = \frac{K}{K+1}$ due to symmetry.  (This is also the misclassification rate from pure guessing.)
