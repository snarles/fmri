...
With some abuse of notation, rewrite information and average Bayes error as functionals of $q(x)$.

\[
\text{I}[q(x)] = \int_0^1 q(x) \log q(x) dx
\]
\[
\text{ABA}_k[q(x)] = \frac{1}{k}\int_{[0, 1]^k} \max_{i=1}^k q(x_i) dx_1 \cdots dx_k
\]
...
\]
Then we conclude that the otpimal $q^*(t)$ takes the form
\[
