...
The differing dimensionality and resolution of data between cell
recording studies and neuroimaging studies leads to usage of different
methods for quantifying decoding precision.  In electrophysiological
recordings, mutual information \cite{Cover2006} and Fisher
information \cite{Yarrow2012} are the most established methods for
quantifying decoding precision.  In neuroimaging studies,
classification accuracy \cite{Haxby2014} is the dominant measure of
precision.
