...
The encoding model can also be given a probabilistic interpretation,
by assuming that the responses are multivariate normal conditional on the stimulus,
\[
\vec{Y}|\vec{X} \sim N(\bB^T \vec{X}, \Sigma).
\]
