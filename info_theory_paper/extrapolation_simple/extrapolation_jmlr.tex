...
\caption{\textbf{Simulation results:} Simulation study consisting of
  ...
  Comparison of various linear spline bases for extrapolation, in
  multivariate Gaussian simulation with $Y \sim N(0, I_{10})$, $X|Y
  ...
  densely packed near 1).  \emph{Top left:} Extrapolating from $k_1 =
  500$ up to $k = 2000$ compared to true accuracy, with $\sigma =
  0.55$. \emph{Top right:} The RMSE of $\widehat{\text{AGA}_{2000}}$
  for varying $k_1$ and $\sigma = 0.55$. \emph{Bottom right:} The
  actual distribution functions $D(u)$ for varying $\sigma$.
  \emph{Bottom left:} The RMSE of $\widehat{\text{AGA}_{2000}}$ for
  $k_1 = 500$ and varying $\sigma$.}
\label{fig:sim_study}
\end{figure}
