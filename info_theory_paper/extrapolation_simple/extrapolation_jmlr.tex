...
\begin{tabular}{cc}
a & b\\
\includegraphics[scale = 0.4]{mcgs2_oneplot.pdf} &
\includegraphics[scale = 0.4]{fig_mcgs2f.pdf}\\
c & d\\
\includegraphics[scale = 0.4]{fig_mgs2.pdf} &
\includegraphics[scale = 0.4]{fig_mcgs2fovs_02.pdf}\\ 
\end{tabular}
\caption{ Comparison of various linear spline bases for extrapolation,
  ...
  densely packed near 1).  (a) Extrapolating from $k_1 = 500$ up to $k
  = 2000$ compared to true accuracy, with $\sigma = 0.55$. (b) The
  RMSE of $\widehat{\text{AGA}_{2000}}$ for varying $k_1$ and $\sigma
  = 0.55$. (c) The actual distribution functions
  $D(u)$ for varying $\sigma$.} (d) The RMSE of $\widehat{\text{AGA}_{2000}}$ for $k_1 = 500$ and varying $\sigma$. 
\label{fig:sim_study}
\end{figure}
