...
within statistics, the problem is again to \emph{discriminate}
...
We see that both the multi-class classification problem and the
...
to infinity. These differences are perhaps sufficient to explain why little
