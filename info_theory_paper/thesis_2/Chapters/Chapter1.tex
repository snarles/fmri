...
$(\vec{z}_i, \vec{x}_i)$, where $\vec{z}_i$ is the pixel intensities
of the presented image, and $\vec{x}_i$ is a three-dimensional map of
...
(CNN) has yielded record performance.  A deep CNN [include explanation
  here].  Google's FaceNet (\cite{schroff2015facenet}), using learned
