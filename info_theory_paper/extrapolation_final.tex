...
% make sure we define the 'margin' terminology in earlier sections
...
j, \ell} = {{R_{i,j,\ell} - 2}\choose{k_2 - 2}}$.  if $i = \ell$, then
...
2}\choose{k_2 - 2}} + I\{\ell = i\}{{R_{i,j,\ell} - 1}\choose{k_2 - 1}}.
\end{equation}
...
\subsubsection{Method 1: Moment method}
...
\subsubsection{Method 2: Regression adjustment method}
...
%enabling unbiased estimation of the average risk.  Therefore, 
Let us
assume
\[
