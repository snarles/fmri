...
% Wrong directions
%However, very often it is the case that a much larger amount of data
%becomes available after the model has already been deployed.  This set
%of growing \emph{post-deployment} data may be even more valuable than
%the initial dataset for two reasons: (i) it may come in a much larger
%quantity, and (ii) it is reflective of actual user behavior ``in the
%wild'', as opposed to the initial dataset which may have been
%collected under rather artificial conditions.  And now there is the
%possibility of \emph{refining} or \emph{retraining} the original
%machine learning model by using this newly collected data.  This
%paradigm of continual refinement has been formalized and studied under
%the concept of \emph{online learning}, and specialized algorithms have
%been developed for this setting.
%In this paper, we are not concerned with the problem of developing new
%algorithms for the online learning setting: rather, we are 
