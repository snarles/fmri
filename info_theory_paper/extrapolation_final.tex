...
We make a strong assumption for the datasets: for both classification
tasks, the number of repeats per class $r_i$ is the same in both
classification problems, $r_1 = r_2 = r$.  We discuss the possibility
of relaxing this condition in the Discussion.
