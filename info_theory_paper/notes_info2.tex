...
\]
$Q^*$ attains the supremum of $\mathcal{L}[Q]$ over \emph{all} quantile functions,
\[
\mathcal{L}[Q^*] = \sup_{Q \in \mathcal{Q}}\mathcal{L}[Q].
\]
...
Define 
\[
\xi^+_{Q, a,b}(t) = I\{t \in [a,b]\} (Q(b) - Q(t))
\]
and
\[
\xi^-_{Q, a,b}(t) = I\{t \in [a,b]\} (Q(a) - Q(t)).
\],
for $0 \leq a \leq b \leq 1.$ Observe that for any $Q \in \mathcal{Q}$
and $\epsilon \in [0, 1]$ and $0 \leq a \leq b \leq 1$, we have $Q
+ \epsilon \xi^+_{Q, a, b} \in \mathcal{Q}$ and $Q
+ \epsilon \xi^-_{Q, a, b} \in \mathcal{Q}$.
