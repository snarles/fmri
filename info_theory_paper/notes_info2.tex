...
\[
\text{maximize} \int z_0^\infty g(z) G^{k-1}(z) dz
\]
...
\item $\int_0^\infty g(z) \log g(z) \leq \alpha.$
\end{itemize}
...
Meanwhile, the objective function, which can also be written
\[
\int_0^\infty z g(z) \left(\int_0^z g(t) dt\right)^{k-1} dz
\]
