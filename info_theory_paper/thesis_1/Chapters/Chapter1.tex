...
neuroscience.  Take for example a cricket, which can sense the
direction of the wind based on sensations in its cercal hairs.  That
is, the cricket behaviorally demonstrates the ability to
\emph{discriminate} the direction of the wind, based on input from its
cercal system.  Neuroscientists then recorded the spiking activity of
the interneurons of the cricket 
