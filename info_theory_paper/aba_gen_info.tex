...
$H_i: \mathcal{I}(\bY; \hat{g}_i(\bX)) < M$.  All of the models which
...
Indeed, the criterion \eqref{eq:model_selection} follows directly from
the stochastic data-processing inequality.  After all, given any alternative encoding model $g'$, we have
\[
\mathcal{I}(\bY; g(\bX)) = \mathcal{I}(\vec{f}(g(\bX)); g(\bX))
\]
