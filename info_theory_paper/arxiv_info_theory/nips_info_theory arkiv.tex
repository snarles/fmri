...
trained on the data. In this paper, we
construct a novel classification-based estimator of mutual information
based on high-dimensional asymptotics. We show that in a particular limiting
...
\centering
\begin{tabular}{ccrl}
\multirow{5}{*}{\includegraphics[scale = 0.5, clip=true, trim=0 0.2in 0 0.5in]{illus_piK_flat.pdf}} &
\multirow{5}{*}{\includegraphics[scale = 0.5, clip=true, trim=0 0.2in 0.4in 0.5in]{ihat_comp.pdf}} & & \\
& & & \\
...
\begin{center}
\begin{tabular}{ccrl}
&\multirow{10}{*}{\includegraphics[scale = 0.5, clip=true, trim=0.4in 0.5in 0 0.5 in]{fig4b.pdf}}&&\\
...
\begin{center}
\includegraphics[scale = 0.5, clip = true, trim = 0 0.5in 0 0.5in]{fig1.pdf}
\end{center}
...
\begin{center}
\includegraphics[scale = 0.5, clip = true, trim = 0 0.5in 0 0.5in]{fig2.pdf}
\end{center}
...
\includegraphics[scale = 0.5, clip=true, trim=0.4in 0.5in 0 0.5in]{fig4.pdf}
\end{center}
...
True parameter $I(X; Y) = 1.322$ \emph{(dashed line.)}
\begin{center}
\includegraphics[scale = 0.6, clip = true, trim = 0 0.5in 0 0.5in]{fig5a.pdf}
\end{center}
...
\includegraphics[scale = 0.6, clip = true, trim = 0 0.5in 0 0.5in]{fig6.pdf}
\end{center}
