...
of "average Bayes error."  Since the error of a
classifier can be used to infer an upper bound on the average Bayes error, 
we develop a lower confidence bounds for mutual information based on a new theoretical lower bound on mutual information as a function of average Bayes error.  Additionally, we develop an estimator of mutual information based on separate high-dimensional asymptotic theory.
