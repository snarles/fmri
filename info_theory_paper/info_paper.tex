...
of "average Bayes error."  Under the assumption that the error of a classifier
approximates the average Bayes error, we obtain an estimate of mutual information
based on an asymptotic functional relationship between average Bayes error and
mutual information.  We demonstrate the utility of our approach in simulated and real data examples.
\end{abstract}
