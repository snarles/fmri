...
#ggsave("approximation/sim_small6_K80_k40.png", width = 6, height = 4)

#save(p, K, Ktarg, ksub, sigma2_seq, true_accs, all_final_predZ, file = "approximation/sim_small6.RData")
