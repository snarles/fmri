...
all_curves <- array(0, dim = c(mc.reps, length(ksubs), length(basis_vecs), K))
...
errs <- (all_curves - true_accs)^2

final_pred_err_mat <- apply(errs[, , , K], c(2, 3), mean)
